...
class loginstep {
    ...
    def enterCredentials(String username, String password) {
        println("I'm inside credentials")
        println("Print username: " + username)  // Proper string concatenation
        println("Print password: " + password)  // Proper string concatenation
	...
	def click() {
		println("im inside click button")
		WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Login'))
		
	}
	
	@Then ("user is navigate to homepage")
	def navigatetohompage() {
		println("im inside navigate to hompage")
